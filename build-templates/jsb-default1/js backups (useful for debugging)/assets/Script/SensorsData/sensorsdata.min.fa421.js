...
var r = new RegExp("\\?(?:.+&)?" + t + "=(.*?)(?:[?&].*)?$"), n = e.match(r);
return n ? n[1] : "";
}

var apiType = getUrlParam(location.href, "apiType");

console.log("!!!!!!", apiType);

var server_url = "0" == apiType ? "http://dcs.coohua.com/data/v1?project=test" : "http://dcs.coohua.com/data/v1?project=mvp";
...
name: "sa",
show_log: !!getUrlParam(location.href, "log"),
...
function e(e) {
r = e, _.isJSONString(r) && (r = JSON.parse(r)), n && n(r);
}
function t() {
if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) {
var e = document.createElement("iframe");
e.setAttribute("src", "sensorsanalytics://getAppInfo"), document.documentElement.appendChild(e), 
...
return t(), "object" == typeof window.SensorsData_APP_JS_Bridge && window.SensorsData_APP_JS_Bridge.sensorsdata_call_app && (r = SensorsData_APP_JS_Bridge.sensorsdata_call_app(), 
_.isJSONString(r) && (r = JSON.parse(r))), e ? void (null === r ? n = e : e(r)) : r;
};
}
...
function str(e, t) {
var r, n, a, i, o, s = gap, c = t[e];
switch (c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), 
"function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
case "string":
return quote(c);
...
if (rep && "object" == typeof rep) for (i = rep.length, r = 0; i > r; r += 1) "string" == typeof rep[r] && (a = str(n = rep[r], c)) && o.push(quote(n) + (gap ? ": " : ":") + a); else for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (a = str(n, c)) && o.push(quote(n) + (gap ? ": " : ":") + a);
return a = 0 === o.length ? "{}" : gap ? "{\n" + gap + o.join(",\n" + gap) + "\n" + s + "}" : "{" + o.join(",") + "}", 
gap = s, a;
}
}
...
function walk(e, t) {
var r, n, a = e[t];
if (a && "object" == typeof a) for (r in a) Object.prototype.hasOwnProperty.call(a, r) && (void 0 !== (n = walk(a, r)) ? a[r] = n : delete a[r]);
...
for (i in sd.para_default) void 0 === sd.para[i] && (sd.para[i] = sd.para_default[i]);
if ("object" == typeof sd.para.server_url && sd.para.server_url.length) for (i = 0; i < sd.para.server_url.length; i++) /sa\.gif[^\/]*$/.test(sd.para.server_url[i]) || (sd.para.server_url[i] = sd.para.server_url[i].replace(/\/sa$/, "/sa.gif").replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2"));
...
var ArrayProto = Array.prototype, FuncProto = Function.prototype, ObjProto = Object.prototype, slice = ArrayProto.slice, toString = ObjProto.toString, hasOwnProperty = ObjProto.hasOwnProperty, LIB_VERSION = "1.7.14";
sd.lib_version = LIB_VERSION;
var error_msg = [], is_first_visitor = !1, just_test_distinctid = 0, just_test_distinctid_2 = 0, just_test_distinctid_detail = 0, just_test_distinctid_detail2 = 0, source_channel_standard = "utm_source utm_medium utm_campaign utm_content utm_term", logger = "object" == typeof logger ? logger : {}, e, t, r, n, a;
...
}, e = (FuncProto.bind, ArrayProto.forEach), t = ArrayProto.indexOf, r = Array.isArray, 
n = {}, a = _.each = function(t, r, a) {
if (null == t) return !1;
if (e && t.forEach === e) t.forEach(r, a); else if (t.length === +t.length) {
for (var i = 0, o = t.length; o > i; i++) if (i in t && r.call(a, t[i], i, t) === n) return !1;
} else for (var s in t) if (hasOwnProperty.call(t, s) && r.call(a, t[s], s, t) === n) return !1;
...
for (var t, r = [], n = {}, a = 0; a < e.length; a++) (t = e[a]) in n || (n[t] = !0, 
r.push(t));
return r;
...
var t, r, n, a, i, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s = 0, c = 0, l = "", u = [];
if (!e) return e;
e = _.utf8Encode(e);
do {
t = (i = e.charCodeAt(s++) << 16 | e.charCodeAt(s++) << 8 | e.charCodeAt(s++)) >> 18 & 63, 
r = i >> 12 & 63, n = i >> 6 & 63, a = 63 & i, u[c++] = o.charAt(t) + o.charAt(r) + o.charAt(n) + o.charAt(a);
} while (s < e.length);
...
var t, r, n = navigator.userAgent, a = [], i = 0;
for (t = 0; t < n.length; t++) r = n.charCodeAt(t), a.unshift(255 & r), a.length >= 4 && (i = e(i, a), 
a = []);
return a.length > 0 && (i = e(i, a)), i.toString(16);
};
return function() {
var r = String(screen.height * screen.width);
r = r && /\d{5,}/.test(r) ? r.toString(16) : String(31242 * Math.random()).replace(".", "").slice(0, 8);
var n = e() + "-" + Math.random().toString(16).replace(".", "") + "-" + t() + "-" + r + "-" + e();
return n ? (just_test_distinctid_2 = 1, n) : (just_test_distinctid_2 = 2, (String(Math.random()) + String(Math.random()) + String(Math.random())).slice(2, 15));
};
...
var e = "";
return e += this._values.Origin, e += this._values.Port ? ":" + this._values.Port : "", 
(e += this._values.Path) + (this._values.QueryString ? "?" + this._values.QueryString : "");
...
t = t || window.event;
var n = r();
e.style.left = t.clientX + n.x - u + "px", e.style.top = t.clientY + n.y - d + "px", 
t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0;
}
function a(e) {
e || (e = window.event), document.removeEventListener ? (document.removeEventListener("mouseup", a), 
document.removeEventListener("mousemove", n)) : document.detachEvent && (document.detachEvent("onmouseup", a), 
document.detachEvent("onmousemove", n)), e.stopPropagation ? e.stopPropagation() : e.cancelBubble = !0;
}
var i = r(), o = t.clientX + i.x, s = t.clientY + i.y, c = e.offsetLeft, l = e.offsetTop, u = o - c, d = s - l;
document.addEventListener ? (document.addEventListener("mousemove", n), document.addEventListener("mouseup", a)) : document.attachEvent && (document.attachEvent("onmousemove", n), 
document.attachEvent("onmouseup", a)), t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, 
...
try {
var n = null != window.frameElement;
} catch (e) {}
document.documentElement.doScroll && !n && function e() {
if (!r) try {
...
var i, o, s = !0;
return _.isFunction(n) && (i = n(a)), o = r.call(e, a), (!1 === i || !1 === o) && (s = !1), 
s;
}
};
}
...
var i = "", o = "", s = "";
if (r = null == r ? 73e3 : r, n = "undefined" == typeof n ? sd.para.cross_subdomain : n) {
var c = _.url("domain", location.href);
i = c ? "; domain=." + c : "";
}
if (0 !== r) {
var l = new Date();
"s" === String(r).slice(-1) ? l.setTime(l.getTime() + 1e3 * Number(String(r).slice(0, -1))) : l.setTime(l.getTime() + 864e5 * r), 
o = "; expires=" + l.toGMTString();
}
...
var t = "";
return t = !1 === sd.para.cross_subdomain ? "string" == typeof (t = _.url("sub", location.href)) && "" !== t ? "sajssdk_2015_" + e + "_" + t : "sajssdk_2015_root_" + e : "sajssdk_2015_cross_" + e;
},
getNewUser: function() {
...
if (n.$element_type = r, n.$element_name = t.getAttribute("name"), n.$element_id = t.getAttribute("id"), 
n.$element_class_name = "string" == typeof t.className ? t.className : null, n.$element_target_url = t.getAttribute("href"), 
t.textContent) {
var a = _.trim(t.textContent);
a && (a = a.replace(/[\r\n]/g, " ").replace(/[ ]+/g, " ").substring(0, 255)), n.$element_content = a || "";
}
return "input" !== r || "button" !== t.type && "submit" !== t.type || (n.$element_content = t.value || ""), 
(n = _.strip_empty_properties(n)).$url = location.href, n.$url_path = location.pathname, 
n.$title = document.title, n;
}, _.localStorage = {
get: function(e) {
...
return r === e ? n : n[0 > (e = parseInt(e.substring(1), 10)) ? n.length + e : e - 1];
}
function n(e, r) {
for (var n = e.charAt(0), a = r.split("&"), i = [], o = {}, s = [], c = e.substring(1), l = 0, u = a.length; u > l; l++) if ((i = a[l].match(/(.*?)=(.*)/)) || (i = [ a[l], a[l], "" ]), 
"" !== i[1].replace(/\s/g, "")) {
if (i[2] = t(i[2] || ""), c === i[1]) return i[2];
(s = i[1].match(/(.*)\[([0-9]+)\]/)) ? (o[s[1]] = o[s[1]] || [], o[s[1]][s[2]] = i[2]) : o[i[1]] = i[2];
}
return n === e ? o : o[c];
}
return function(t, a) {
...
if ((i = a.match(/(.*?)\/#\!(.*)/)) && (a = i[1] + i[2]), (i = a.match(/(.*?)#(.*)/)) && (o.hash = i[2], 
a = i[1]), o.hash && t.match(/^#/)) return n(t, o.hash);
if ((i = a.match(/(.*?)\?(.*)/)) && (o.query = i[2], a = i[1]), o.query && t.match(/^\?/)) return n(t, o.query);
if ((i = a.match(/(.*?)\:?\/\/(.*)/)) && (o.protocol = i[1].toLowerCase(), a = i[2]), 
(i = a.match(/(.*?)(\/.*)/)) && (o.path = i[2], a = i[1]), o.path = (o.path || "").replace(/^([^\/])/, "/$1").replace(/\/$/, ""), 
t.match(/^[\-0-9]+$/) && (t = t.replace(/^([^\/])/, "/$1")), t.match(/^\//)) return r(t, o.path.substring(1));
if ((i = r("/-1", o.path.substring(1))) && (i = i.match(/(.*?)\.(.*)/)) && (o.file = i[0], 
o.filename = i[1], o.fileext = i[2]), (i = a.match(/(.*)\:([0-9]+)$/)) && (o.port = i[2], 
a = i[1]), (i = a.match(/(.*?)@(.*)/)) && (o.auth = i[1], a = i[2]), o.auth && (i = o.auth.match(/(.*)\:(.*)/), 
o.user = i ? i[1] : o.auth, o.pass = i ? i[2] : void 0), o.hostname = a.toLowerCase(), 
"." === t.charAt(0)) return r(t, o.hostname);
e() && (i = o.hostname.match(e())) && (o.tld = i[3], o.domain = i[2] ? i[2] + "." + i[3] : void 0, 
o.sub = i[1] || void 0), o.port = o.port || ("https" === o.protocol ? "443" : "80"), 
...
this.ele.setAttribute(e, t)), this);
},
offset: function() {
...
return 0 === (e = e || document.referrer).indexOf("https://www.baidu.com/") && (e = e.split("?")[0]), 
"string" == typeof (e = e.slice(0, sd.para.max_referrer_string_length)) ? e : "";
}, _.info = {
initPage: function() {
var e = _.getReferrer(), t = e ? _.url("hostname", e) : e, r = e ? _.url("domain", e) : e, n = location.href, a = n ? _.url("hostname", n) : n, i = n ? _.url("domain", n) : n;
this.pageProp = {
referrer: e,
referrer_host: t,
referrer_domain: r,
...
e = _.unique(e)), _.each(e, function(e) {
...
if (e._nocache = (String(Math.random()) + String(Math.random()) + String(Math.random())).replace(/\./g, "").slice(0, 15), 
e = JSON.stringify(e), sd.para.use_app_track) {
if ("object" == typeof SensorsData_APP_JS_Bridge && SensorsData_APP_JS_Bridge.sensorsdata_track) SensorsData_APP_JS_Bridge.sensorsdata_track(e), 
logger.info("app数据", e); else if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) {
var r = document.createElement("iframe");
r.setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(e)), 
document.documentElement.appendChild(r), r.parentNode.removeChild(r), r = null;
}
return "function" == typeof t && t(), !1;
}
logger.info(e), this.prepareServerUrl(e, t);
}, sd.sendState.prepareServerUrl = function(e, t) {
if (_.isArray(sd.para.server_url)) for (var r = 0; r < sd.para.server_url.length; r++) -1 !== sd.para.server_url[r].indexOf("?") ? this.sendCall(sd.para.server_url[r] + "&data=" + encodeURIComponent(_.base64Encode(e)), t) : this.senCall(sd.para.server_url[r] + "?data=" + encodeURIComponent(_.base64Encode(e)), t); else -1 !== sd.para.server_url.indexOf("?") ? this.sendCall(sd.para.server_url + "&data=" + encodeURIComponent(_.base64Encode(e)), t) : this.sendCall(sd.para.server_url + "?data=" + encodeURIComponent(_.base64Encode(e)), t);
}, sd.sendState.callBack = function(e) {
"function" == typeof e && e();
}, sd.sendState.sendCall = function(e, t) {
++this._receive;
var r = "_state" + this._receive, n = this;
this[r] = document.createElement("img"), this[r].onload = function() {
n[r].onload = null, delete n[r], ++n._complete, n.callBack(t);
}, this[r].onerror = function() {
n[r].onerror = null, delete n[r], n.callBack(t);
}, this[r].onabort = function() {
delete n[r], n.callBack(t);
}, this[r].src = e;
};
var saNewUser = {
...
null != r && _.isJSONString(r) && (n = JSON.parse(r)).$device_id && (t = n.$device_id), 
t = t || e, !0 === sd.para.cross_subdomain ? store.set("$device_id", t) : (n.$device_id = t, 
_.cookie.set("sensorsdata2015jssdkcross", JSON.stringify(n), null, !0)), sd.para.is_track_device_id && (_.info.currentProps.$device_id = t);
},
...
return _.strip_sa_properties(e), !(e && (_.isObject(e) ? !this.checkPropertiesKey(e) && (logger.info("properties里的key必须是由字符串数字_组成，且不能是系统保留字"), 
0) : (logger.info("properties可以没有，但有的话必须是对象"), 0)));
},
propertiesMust: function(e) {
return _.strip_sa_properties(e), void 0 === e || !_.isObject(e) || _.isEmptyObject(e) ? (logger.info("properties必须是对象且有值"), 
...
_.extend(r, e), error_msg.length > 0 && (r.jssdk_error = error_msg.join("--")), 
_.isObject(e.properties) && !_.isEmptyObject(e.properties) && _.extend(r.properties, e.properties), 
_.isObject(t) && _.extend(r.lib, t), e.type && "profile" === e.type.slice(0, 7) || (r.properties = _.extend({}, _.info.properties(), store.getProps(), store.getSessionProps(), _.info.currentProps, r.properties)), 
...
_.searchObjDate(r), _.searchObjString(r), saNewUser.checkIsAddSign(r), saNewUser.checkIsFirstTime(r), 
!0 === sd.para.debug_mode ? (logger.info(r), this.debugPath(JSON.stringify(r), t)) : sd.sendState.getSendCall(r, t);
}, saEvent.debugPath = function(e) {
var t, r = e;
t = -1 !== sd.para.debug_mode_url.indexOf("?") ? sd.para.debug_mode_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : sd.para.debug_mode_url + "?data=" + encodeURIComponent(_.base64Encode(e)), 
_.ajax({
url: t,
type: "GET",
cors: !0,
...
toState: function(e) {
var t = null;
if (null != e && _.isJSONString(e)) if (t = JSON.parse(e), this._state = _.extend(t), 
t.distinct_id) {
...
} else this.set("distinct_id", _.UUID()), error_msg.push("toStateParseDistinctError"); else this.set("distinct_id", _.UUID()), 
...
var e = "";
return e = !1 === sd.para.cross_subdomain ? "string" == typeof (e = _.url("sub", location.href)) && "" !== e ? "sa_jssdk_2015_" + e : "sa_jssdk_2015_root" : "sensorsdata2015jssdkcross";
},
init: function() {
...
null === t ? (is_first_visitor = !0, just_test_distinctid = 1, this.set("distinct_id", e)) : (just_test_distinctid = 2, 
just_test_distinctid_detail = JSON.stringify(t), just_test_distinctid_detail2 = navigator.userAgent + "^_^" + document.cookie, 
_.isJSONString(t) && JSON.parse(t).distinct_id || (is_first_visitor = !0), this.toState(t)), 
saNewUser.setDeviceId(e), saNewUser.storeInitCheck(), saNewUser.checkIsFirstLatest();
}
}, commonWays = {
getUtm: function() {
...
allTrack: function() {
return document && document.body ? !sd.para.heatmap && (sd.para.heatmap = {}, heatmap.init(), 
!1) : (setTimeout(this.allTrack, 1e3), !1);
},
...
var a = null;
return (e = e || {}).ele && (a = e.ele), e.event && (a = e.target ? e.target : e.event.target), 
r = r || {}, !(!a || "object" != typeof a) && (!a.href || /^javascript/.test(a.href) || a.target || a.download || a.onclick ? (sd.track(t, r), 
!1) : (e.event && n(e.event), void (e.ele && _.addEvent(e.ele, "click", function(e) {
n(e);
}))));
...
distinct_id: e
}) ? !0 === t ? r ? store.set("first_id", e) : store.set("distinct_id", e) : r ? store.change("first_id", e) : store.change("distinct_id", e) : logger.info("identify的参数必须是字符串");
...
}, sd.trackAbtest = function() {}, sd.registerPage = function(e) {
saEvent.check({
properties: e
...
t ? (store.set("first_id", ""), !0 === e ? store.set("distinct_id", _.UUID()) : store.set("distinct_id", t)) : logger.info("没有first_id，logout失败");
};
var heatmap_render = {
heatDataElement: [],
setRefresh: function() {
var e = this, t = document.createElement("div");
t.setAttribute("style", "border-radius:3px;cursor:pointer;z-index:99999;padding:8px 10px;background:#3790e9;color:#fff;position: fixed;left:10px;bottom:10px;"), 
...
document.body.appendChild(t), _.addEvent(t, "click", function() {
e.refreshHeatData(), e.showErrorInfo(5);
});
},
...
1 === e ? r.innerHTML = "当前页面在所选时间段内暂时没有点击数据" : 2 === e ? t.error ? r.innerHTML = t.error : r.innerHTML = "请求数据异常" : 3 === e ? r.innerHTML = "当前页面在所选时间段内暂时没有点击数据" : 4 === e ? t.error ? r.innerHTML = t.error : r.innerHTML = "请求数据异常" : 5 === e && (r.style.backgroundColor = "#3790e9", 
r.innerHTML = "刷新点击图数据成功"), document.body.appendChild(r), setTimeout(function() {
...
var i = a.getUrl();
i = -1 === i.indexOf("?") ? i + "?pathUrl=" + t : i + "&pathUrl=" + t, t ? (this.requestType = 3, 
_.ajax({
url: i,
type: "POST",
cors: !0,
...
error: function(e) {
r.showErrorInfo(2, e), sessionStorage.removeItem("sensors_heatmap_id"), 0 === location.href.indexOf("http://www.notrack.com:8080/sdk_test.html") && (r.bindEffect(), 
r.calculateHeatData(window.data_sa_heat_test_data_test_201703130440 || {}));
}
...
error: function(e) {
r.showErrorInfo(4, e), sessionStorage.removeItem("sensors_heatmap_id"), 0 === location.href.indexOf("http://www.notrack.com:8080/sdk_test.html") && (r.bindEffect(), 
r.calculateHeatData(window.data_sa_heat_test_data_test_201703130440 || {}));
}
}));
...
}), 0 === i.length && t.showErrorInfo(t.requestType), e = i, _.each(e, function(e) {
e.value_fix = e.values[0][0], a += e.value_fix;
}), t.data_render = e, _.each(e, function(e, i) {
if (e.by_values[0]) {
e.data_page_percent = Number(e.value_fix / a * 100).toFixed(2) + "%", e.data_click_percent = Number(e.value_fix / r * 100).toFixed(2) + "%", 
e.data_click = Number(e.value_fix / r), e.data_page = Number(e.value_fix / a);
var o = new _.urlParse(sd.para.web_url);
o._values.Path = "/web-click/users", e.data_user_link = o.getUrl() + "#heat_map_id=" + n + "&element_selector=" + encodeURIComponent(e.by_values[0]), 
"null" === String(e.top_values[0]) ? e.data_top_value = "没有值" : e.data_top_value = String(e.top_values[0]);
...
n = n.wrap("span"), "string" == typeof a && "%" === a.slice(-1) && (n.ele.style.width = a), 
n.ele.style.display = "inline-block";
}
this.heatDataElement.push(n), n.attr("data-heat-place", String(r)).addClass("sa-click-area").attr("data-click", t.data_click_percent).addClass("sa-click-area" + this.heatData(t.data_click)), 
...
if ("fixslidedown" === this.is_fix_state) t.style.position = "fixed", t.style.left = "auto", 
t.style.right = 0, t.style.top = 0, r && (t.className = "sa-heat-box-effect-2017314"); else if ("notfix" === this.is_fix_state) {
var n = heatmap.getBrowserWidth(), a = e.target, i = _.ry(a).offset(), o = _.ry(a).getSize(), s = i.left + o.width + 2, c = i.top + 1;
s + 220 > n && (s = i.left - 220, i.left < 220 && (s = e.pageX)), t.style.position = "absolute", 
t.style.left = s + "px", t.style.top = c + "px";
}
"block" !== t.style.display && (t.style.display = "block");
},
bindEffect: function() {
function e(e) {
var t = e.target, n = t.getAttribute("data-heat-place"), l = r.data_render[n];
if (!l) return !1;
var u = _.trim(t.textContent);
u && (u = u.replace(/[\r\n]/g, " ").replace(/[ ]+/g, " ").substring(0, 255)), l.data_current_content = u || "没有值", 
i = a.replace(/\{\{[^\{\{]+\}\}/g, function(e) {
return "string" == typeof (e = e.slice(2, -2)) && "object" == typeof l ? l[e] : void 0;
}), c.innerHTML = i, r.showEffectBox(e, s, o);
}
function t(t) {
var r = t.target;
setTimeout(function() {
...
return e && "body" !== r && 1 == e.nodeType ? (t.unshift(this.selector(e)), e.id ? t.join(" > ") : this.getDomSelector(e.parentNode, t)) : (t.unshift("body"), 
t.join(" > "));
},
na: function() {
...
var n = this.getDomSelector(t), a = _.getEleInfo({
target: t
});
a.$element_selector = n || "", "a" === r && sd.para.heatmap && !0 === sd.para.heatmap.isTrackLink ? _.trackLink({
event: e,
target: t
...
}, sd.para.heatmap.loadTimeout || 0)) : (alert("请更新到最新版浏览器,建议用chrome或者firefox"), 
!1);
}
var r = location.search.match(/sa-request-id=([^&]+)/), n = this;
r && r[0] && r[1] ? (sd.is_heatmap_render_mode = !0, "object" == typeof window.sessionStorage && sessionStorage.setItem && sessionStorage.setItem("sensors_heatmap_id", r[1]), 
t(r[1])) : "object" == typeof window.sessionStorage && sessionStorage.setItem && "string" == typeof sessionStorage.getItem("sensors_heatmap_id") ? (sd.is_heatmap_render_mode = !0, 
t(sessionStorage.getItem("sensors_heatmap_id"), location.href)) : (e(), _.isObject(sd.para.heatmap) && this.init());
},
init: function() {
var e = this;
return !!_.isObject(sd.para.heatmap) && !(_.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url()) && ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", 
void ("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function(t) {
var r = t || window.event, n = r.target || r.srcElement, a = n.tagName.toLowerCase();
