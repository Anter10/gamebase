...
console.log('!!!!!!', apiType)
var server_url = apiType == '0' ? 'http://dcs.coohua.com/data/v1?project=test' : 'http://dcs.coohua.com/data/v1?project=mvp';
(function (para) {
    var n = para.name;
